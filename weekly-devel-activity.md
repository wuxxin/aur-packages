...
---## 📅 Summary of Last 7 Days Activity (June 12, 2026 – June 18, 2026) 
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- | :--- | :---: | :---: |
| **libggml-git-hip** | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) | 117,207 | 19,711 | `master` | 2026-06-18 | **113** | 0 | 75 | 108.2 | `b9707`, `b9704` | `9692.r0.gf3e1828-1` (built 2026-06-18) | 24 | **Highly Active** |
| *└─ python-llama-cpp-git-ggml-hip* | [abetlen/llama-cpp-python](https://github.com/abetlen/llama-cpp-python) | 10,414 | 1,417 | `main` | 2026-06-16 | **11** | 0 | 29 | 22.2 | `v0.3.30`, `v0.3.29` | `9692.r0.gf3e1828-1` (ref `ddb6a05`) | 0 | **Active** |
| *└─ stable-diffusion.cpp-git-ggml-hip* | [leejet/stable-diffusion.cpp](https://github.com/leejet/stable-diffusion.cpp) | 6,303 | 667 | `master` | 2026-06-17 | **25** | 0 | 20 | 17.0 | `master-709-92a3b73` | `9692.r0.gf3e1828-1` (ref `7f0e728`) | 0 | **Active** |
| *└─ whisper.cpp-git-ggml-hip* | [ggerganov/whisper.cpp](https://github.com/ggerganov/whisper.cpp) | 50,843 | 5,675 | `master` | 2026-06-18 | **29** | 0 | 2 | 50.7 | `v1.9.0`, `v1.8.7` | `9692.r0.gf3e1828-1` (ref `86c40c3`) | 1 | **Active** |
| *└─ qwen3-tts.cpp-git-ggml-hip* | [khimaros/qwen3-tts.cpp](https://github.com/khimaros/qwen3-tts.cpp) (Fork) | 16 | 3 | `main` | 2026-06-16 | **1** | 0 | 0 | 0.2 | — | `9692.r0.gf3e1828-1` (ref `0c8b2ba`) | 0 | **Stale** |
| *   └─ [Fork Origin]* | [predict-woo/qwen3-tts.cpp](https://github.com/predict-woo/qwen3-tts.cpp) | 205 | 69 | `main` | 2026-06-03 | **0** | 0 | 0 | 0.2 | — | — | — | **Stale** |
| **python-bitsandbytes-rocm-git** | [bitsandbytes-foundation/bitsandbytes](https://github.com/bitsandbytes-foundation/bitsandbytes) | 8,277 | 873 | `main` | 2026-06-18 | **4** | 0 | 0 | 4.0 | — | `0.49.2.r89.gaee0ebba-1` (built 2026-06-18) | 2 | **Active** |
| **python-vllm-rocm-git** | [vllm-project/vllm](https://github.com/vllm-project/vllm) | 83,280 | 18,205 | `main` | 2026-06-18 | **267** | 0 | 1 | 239.7 | `v0.23.1rc0` | not installed | — | **Highly Active** |
| **python-vllm-omni-rocm-git** | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | 5,196 | 1,134 | `main` | 2026-06-18 | **74** | 0 | 1 | 78.0 | `v0.23.0rc1` | not installed | — | **Highly Active** |
...
| **python-pocket-tts** | [kyutai-labs/pocket-tts](https://github.com/kyutai-labs/pocket-tts) | 4,628 | 512 | `main` | 2026-06-03 | **0** | 0 | 0 | 0.7 | — | `2.1.0-1` (built 2026-06-17) | 5 | **Stale** |
...
| Package | Upstream Repo | Stars | Forks | Main Branch | Last Commit | Commits (Last Wk) | Merges (Last Wk) | Releases/Tags (Last Wk) | Avg Commits/Wk (4 Wks) | Recent Tags / Versions | Installed Pkg Version | Commits Since Installed | Status |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- | :--- | :---: | :---: |
| **signal-cli-rest-api-git** | [bbernhard/signal-cli-rest-api](https://github.com/bbernhard/signal-cli-rest-api) | 2,644 | 295 | `master` | 2026-06-11 | **0** | 0 | 0 | 4.0 | `0.100` | `0.100.r0.ga4f5855-1` (built 2026-06-18) | 0 | **Active** |
...
* **Status**: Highly Active (113 commits, 75 tags in the last week, as of June 18).
* **Recent Focus**:
  - **Server & WebUI**: Added model management API (`b4024af6`). Added SVG block rendering (`2a6c391a`), source toggle to mermaid and svg blocks (`c1304d7b`), conversation export as jsonl (`8086439a`), and SSE transport/CORS proxy fixes (`bae36efa`). Added last-5-seconds generation speed display (`08023072`), schema support and validation (`e1efd099`), returning HTTP 400 on invalid grammar (`10786217`), touch-accessible model selection UI (`20832179`), and "X-Accel-Buffering": "no" header to streaming endpoints (`40f3aafc`).
  - **Hardware Backends & Kernels**:
    - *Metal*: Implemented `rope_back` operator (`0843245c`), f16/bf16 support for concat operator (`8d2e5806`), repeat bf16 support (`272088b9`), and check for BF16 support in concat kernel (`cae0a3b0`).
    ...
    - *SYCL*: Added dev2dev memcpy by SYCL API (`74a80dd9`), Conv3D support (`d1759e41`), fp16 support for various ops (SQR, SQRT, LOG, SIN, COS, CLAMP) (`58728bdb`), fixed use-after-free bug in MoE prefill (`ebbc1e51`), supported USM system allocations (`9b260fc9`), supported reordered Q4_K/Q5_K/Q6_K MoE MUL_MAT_ID (`ac79caa7`), supported OP EXPM1, supported FLOOR, TRUNC, ROUND UT cases (`fdd10988`). Made `GGML_SYCL_F16=ON` default (`4196b477`). Renamed GGML_SYCL_SUPPORT_LEVEL_ZERO (`9724f664`), supported MUL_MAT and OUT_PROD with Q1_0 (`dd69db29`), and supported conv_2d, conv_2d_dw, conv2d_transpose (`6f1034b3`).
    - *Hexagon*: Added support for fine-grain op-trace logging of HVX/HMX/DMA events (`d2c67959`).
    - *CUDA*: Added CUDA col2im 1d kernel (`3a3edc9a`).
  - **Models & Speculative Decoding**: Added backend sampling support for Eagle3 speculative decoding (`a1824902`), fixed Eagle3 segfaults on long prompts (`1a2dea29`), and added spec metrics (`635b65ad`). Fixed and restricted NVFP4 edge-cases in llama-graph (`02810c7a`). Conditionally enabled Power11 backend on CPU (`2e88c49c`). Added MTMD batching support for InternVL (`db52540f`), batching for mtmd-cli and video tests (`a6b3260a`), and refactored LLaVA-UHD overview image handling (`060ce1bf`).
...
* **Status**: Active (11 commits, 29 tags in the last week, as of June 18).
* **Recent Focus**:
...
* **Status**: Active (25 commits, 20 tags in the last week, as of June 18).
* **Recent Focus**:
...
* **Status**: Active (29 commits, 2 tags in the last week, as of June 18).
* **Recent Focus**:
...
* **Status**: Stale (1 commit in the last week on downstream fork, 0 commits on origin, as of June 18).
* **Fork & Feature Parity**:
...
* **Status**: Active (4 commits in the last week, as of June 18).
* **Recent Focus**:
  - **CI & Compatibility**: Pin GitHub Actions to SHA and add dependabot for automatic updates (`435b8b3`), misc CI cleanups (`78a8478`), and CI compatibility support for Windows 2025 + VS2026 (`aee0ebb`).
...
* **Status**: Highly Active (267 commits, 1 tag in the last week, as of June 18).
* **Recent Focus**:
  ...
  - **KV Connector / Offloading**: Avoid blocking engine to flush offloads on idle (`6d8fff56`), added cache_prefix to Mooncake namespace store keys (`44b25127`), and added selective offload documentation (`ee0fd698`). Added async lookup to reduce scheduler overhead for Mooncake (`35e4dd4a`).
...
* **Status**: Highly Active (74 commits, 1 tag in the last week, as of June 18).
* **Recent Focus**:
  - **Refactoring & Platform Architecture**: Extracted `OmniStreamingVideoHandler` base and `QwenOmniStreamingVideoHandler` (`d744940b`). Omni Stage Runtime and Distributed Replica Control Plane refactored (`64a5bb92`), and migrated pipelines to `SupportsComponentDiscovery` for offload discovery (`e957d16f`). Added base class for dit pipelines with unified parameter declaration (`f75c437a`).
  - **Audio & TTS Models**: Qwen3-TTS: trim reference audio in `no_async_chunk` voice clone (`a693ae67`). Shim `PreTrainedModel._tp_plan` to fix `MOSS-TTS-Nano` load crash (`d78a92ec`). Lazy load codec for `higgs-audio-v3` under `load_format=dummy` (`dc143807`). MOSS-TTS: fix cross-request audio corruption under batching (`1228a109`).
  - **Diffusion Models (Image/Video)**:
    ...
    - *DreamZero*: Fixed tensor-parallel and cross-attention cache (`8f28b969`).
    - *Other Models*: Supported SDXL model enabling (`e7f0db10`). Regional compile enabled for Cosmos3 HSDP blocks (`14d70d98`).
  ...
  - **Triton & Kernels**: Introduced High-Performance MoT (Mixture-of-Tokens) Kernels in Triton (`46ed7c14` / `#3960`). Added NPU support for OmniMRotaryEmbedding (`c7827461`).
  - **CI & Metrics**: Wire `log_stats` to `AsyncOmni` and add missing token metrics for non-text requests (`8fa0394d`). Added `vllm-omni-test` agent skill for CI-aligned test generation (`dff8cda8`).

### PocketTTS.cpp (`VolgaGerm/PocketTTS.cpp` & `kyutai-labs/pocket-tts`)
* **Status**: Stale (0 commits in the last week, as of June 18).
* **Recent Focus**:
...
* **Status**: Active (0 commits in the last week, as of June 18).
* **Recent Focus**:
...
# Reference hashes corresponding to build date June 18, 2026
declare -A PKG_REFS=(
  [llama.cpp]="f3e1828"
  [llama-cpp-python]="ddb6a05"
  [stable-diffusion.cpp]="7f0e728"
  [whisper.cpp]="86c40c3"
  [qwen3-tts.cpp]="0c8b2ba"
  [bitsandbytes]="aee0ebba"
  [vllm]="6bdabba"
  [vllm-omni]="5dfdf58"
  [pockettts.cpp]="e801e7d"
  [pocket-tts]="v2.1.0"
  [signal-cli-rest-api]="a4f5855"
)
